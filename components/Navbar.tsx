...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-[#FFFBEB] shadow-sm  w-full z-50">
      <div className="flex flex-col md:flex-row justify-center items-center py-4 px-6 md:px-10 lg:px-20">
        ...
        <div className="flex md:hidden justify-between items-center w-full">
          ...
          <button
            ...
            className="text-[#D97706] focus:outline-none z-50"
          >
      ...
      <div
        className={`fixed top-0 right-0 h-screen w-[70%] bg-[#FFFBEB] shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
